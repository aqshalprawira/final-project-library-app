...
async function handleClickEditButton(bookId) {
  try {
    ...
    const res = await fetch(`http://localhost:3333/books/${bookId}`); // get
...
async function handleEditForm(event) {
  try {
    ...
    */
    ...
    let penulis = document.getElementById('author');
  ...
  try {
    ...
    */
    // TODO: answer here
        ...
        const res = await fetch("http://localhost:3333/books"); // get
